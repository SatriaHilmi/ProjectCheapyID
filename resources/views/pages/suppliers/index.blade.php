    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                Daftar supplier yang terdaftar.
            </p>

            <div class="card">
                <div class="card-header">
                    <a href="{{ route('suppliers.create') }}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('suppliers.edit', $item->id) }}" class="btn btn-success btn-icon icon-left">
